...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">N  S I</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    {{--{!! Html::linkAction( 'Admin\MainController@profile','Profile',[],array('class' => 'btn')) !!}--}}

                                </div>
                                <div class="pull-right">
                                    {!! Html::linkRoute('logout', 'Sign Out',array('class'=>'btn btn-default btn-flat')) !!}
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a href="http://improvis.com">Improvis Web Studio</a>.</strong> All rights reserved.
    </footer>
